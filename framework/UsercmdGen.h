...
const int IMPULSE_23			= 23;			// superspeed (actuall attack rn)
const int IMPULSE_24			= 24;			// invisibility
const int IMPULSE_25			= 25;			// teleortation
const int IMPULSE_26			= 26;			// TBH
const int IMPULSE_27			= 27;			// TBH
